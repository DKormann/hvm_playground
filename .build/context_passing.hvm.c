...
Term mut_f(Term);
Term spt_f(Term);
Term list_to_tree_slow_f(Term);
Term list_to_tree_fast_par_f(Term);
Term N_f(Term);
Term main_f(Term);
Term LOG_f(Term);
Term SUP_f(Term);
...
Term mut_t(Term);
Term spt_t(Term);
Term list_to_tree_slow_t(Term);
Term list_to_tree_fast_par_t(Term);
Term N_t(Term);
Term main_t(Term);
Term LOG_t(Term);
Term SUP_t(Term);
...
Term is_node_t(Term ref) {
  Term arg0 = got(term_loc(ref) + 0);
  Loc mat1 = alloc_node(3);
  set(mat1 + 0, arg0);
  set(mat1 + 1, term_new(W32, 0, 0));
  Loc lam2 = alloc_node(1);
  Loc lam3 = alloc_node(1);
  set(lam3 + 0, term_new(W32, 0, 1));
  set(lam2 + 0, term_new(LAM, 0, lam3));
  set(mat1 + 2, term_new(LAM, 0, lam2));
  return term_new(MAT, 3, mat1);
}

Term is_node_f(Term ref) {
  u64 itrs = 0;
  Term arg0 = got(term_loc(ref) + 0);
  while (1) {
    Term val1 = (arg0);
    if (term_tag(val1) == CTR) {
      switch (term_lab(val1) - 3) {
        case 0: {
          itrs += 1;
          *HVM.itrs += itrs;
        ...
        case 1: {
          Term fd3 = got(term_loc(val1) + 0);
          Term fd4 = got(term_loc(val1) + 1);
          itrs += 3;
          *HVM.itrs += itrs;
          return term_new(W32, 0, 1);
          break;
        }
      }
    }
    set(term_loc(ref) + 0, arg0);
    return is_node_t(ref);
  }
}


Term range_t(Term ref) {
  Term arg0 = got(term_loc(ref) + 0);
  Term arg1 = got(term_loc(ref) + 1);
  Loc mat2 = alloc_node(3);
  set(mat2 + 0, arg0);
  Loc lam3 = alloc_node(1);
  set(lam3 + 0, term_new(VAR, 0, lam3 + 0));
  set(mat2 + 1, term_new(LAM, 0, lam3));
  Loc lam4 = alloc_node(1);
  Loc lam5 = alloc_node(1);
  Loc dup6 = alloc_node(1);
  set(dup6 + 0, term_new(VAR, 0, lam4 + 0));
  Loc ref7 = alloc_node(2);
  Loc ctr8 = alloc_node(2);
  set(ctr8 + 0, term_new(DP1, 0, dup6 + 0));
  set(ctr8 + 1, term_new(VAR, 0, lam5 + 0));
  set(ref7 + 0, term_new(DP0, 0, dup6 + 0));
  set(ref7 + 1, term_new(CTR, 2, ctr8));
  set(lam5 + 0, term_new(REF, 1, ref7));
  set(lam4 + 0, term_new(LAM, 0, lam5));
  set(mat2 + 2, term_new(LAM, 0, lam4));
  Loc app9 = alloc_node(2);
  set(app9 + 0, term_new(SWI, 2, mat2));
  set(app9 + 1, arg1);
  return term_new(APP, 0, app9);
}

Term range_f(Term ref) {
  u64 itrs = 0;
  Term arg0 = got(term_loc(ref) + 0);
  Term arg1 = got(term_loc(ref) + 1);
  while (1) {
    Term val2 = (arg0);
    if (term_tag(val2) == W32) {
      u32 num3 = term_loc(val2);
      switch (num3) {
        case 0: {
          itrs += 2;
          *HVM.itrs += itrs;
        ...
        default: {
          Term pre4 = term_new(W32, 0, num3 - 1);
          Term val5 = (pre4);
          Term dpA6;
          Term dpB7;
          if (term_is_atom(val5)) {
            itrs += 1;
            dpA6 = val5;
            dpB7 = val5;
          } else {
            Loc dup8 = alloc_node(1);
            set(dup8 + 0, val5);
            dpA6 = term_new(DP0, 0, dup8 + 0);
            dpB7 = term_new(DP1, 0, dup8 + 0);
          }
          arg0 = dpA6;
          Loc ctr9 = alloc_node(2);
          set(ctr9 + 0, dpB7);
          set(ctr9 + 1, arg1);
          arg1 = term_new(CTR, 2, ctr9);
          itrs += 4;
          continue;
          break;
        }
...
Term fst_t(Term ref) {
  Term arg0 = got(term_loc(ref) + 0);
  Loc mat1 = alloc_node(2);
  set(mat1 + 0, arg0);
  Loc lam2 = alloc_node(1);
  Loc lam3 = alloc_node(1);
  set(lam3 + 0, term_new(VAR, 0, lam2 + 0));
  set(lam2 + 0, term_new(LAM, 0, lam3));
  set(mat1 + 1, term_new(LAM, 0, lam2));
  return term_new(MAT, 0, mat1);
}
...
Term tm0_t(Term ref) {
  Term arg0 = got(term_loc(ref) + 0);
  Loc dup1 = alloc_node(1);
  set(dup1 + 0, arg0);
  return term_new(DP0, 0, dup1 + 0);
}
...
Term tm0_f(Term ref) {
  ...
  while (1) {
    ...
    Term dpA2;
    Term dpB3;
    if (term_is_atom(val1)) {
      itrs += 1;
      dpA2 = val1;
      dpB3 = val1;
    } else {
      Loc dup4 = alloc_node(1);
      set(dup4 + 0, val1);
      dpA2 = term_new(DP0, 0, dup4 + 0);
      dpB3 = term_new(DP1, 0, dup4 + 0);
    }
    itrs += 0;
    *HVM.itrs += itrs;
    return dpA2;
...
Term mut_t(Term ref) {
  Term arg0 = got(term_loc(ref) + 0);
  Term arg1 = got(term_loc(ref) + 1);
  Loc let2 = alloc_node(2);
  Loc app3 = alloc_node(2);
  Loc app4 = alloc_node(2);
  set(app4 + 0, arg0);
  set(app4 + 1, 0);
  set(app3 + 0, arg1);
  set(app3 + 1, term_new(APP, 0, app4));
  set(let2 + 0, term_new(APP, 0, app3));
  set(let2 + 1, term_new(ERA, 0, 0));
  set(app4 + 1, term_new(VAR, 0, let2 + 0));
  return term_new(LET, 1, let2);
}
...
Term spt_t(Term ref) {
  ...
  Loc app3 = alloc_node(2);
  Loc lam4 = alloc_node(1);
  Loc app5 = alloc_node(2);
  set(app5 + 0, arg0);
  set(app5 + 1, 0);
  set(lam4 + 0, term_new(APP, 0, app5));
  set(app3 + 0, arg1);
  set(app3 + 1, term_new(LAM, 0, lam4));
  Loc lam6 = alloc_node(1);
  set(lam6 + 0, term_new(VAR, 0, lam4 + 0));
  set(app2 + 0, term_new(APP, 0, app3));
  set(app2 + 1, term_new(LAM, 0, lam6));
  set(app5 + 1, term_new(VAR, 0, lam6 + 0));
...
Term list_to_tree_slow_t(Term ref) {
  Term arg0 = got(term_loc(ref) + 0);
  Term arg1 = got(term_loc(ref) + 1);
  Loc mat2 = alloc_node(3);
  set(mat2 + 0, arg0);
  Loc lam3 = alloc_node(1);
  Loc mat4 = alloc_node(3);
  set(mat4 + 0, term_new(VAR, 0, lam3 + 0));
  set(mat4 + 1, term_new(ERA, 0, 0));
  Loc lam5 = alloc_node(1);
  Loc lam6 = alloc_node(1);
  Loc ctr7 = alloc_node(2);
  Loc ctr8 = alloc_node(1);
  set(ctr8 + 0, term_new(VAR, 0, lam5 + 0));
  set(ctr7 + 0, term_new(VAR, 0, lam6 + 0));
  set(ctr7 + 1, term_new(CTR, 3, ctr8));
  set(lam6 + 0, term_new(CTR, 0, ctr7));
  set(lam5 + 0, term_new(LAM, 0, lam6));
  set(mat4 + 2, term_new(LAM, 0, lam5));
  set(lam3 + 0, term_new(MAT, 1, mat4));
  set(mat2 + 1, term_new(LAM, 0, lam3));
  Loc lam9 = alloc_node(1);
  Loc lam10 = alloc_node(1);
  Loc dup11 = alloc_node(1);
  set(dup11 + 0, term_new(VAR, 0, lam9 + 0));
  Loc mat12 = alloc_node(2);
  Loc ref13 = alloc_node(2);
  set(ref13 + 0, term_new(DP0, 0, dup11 + 0));
  set(ref13 + 1, term_new(VAR, 0, lam10 + 0));
  set(mat12 + 0, term_new(REF, 8, ref13));
  Loc lam14 = alloc_node(1);
  Loc lam15 = alloc_node(1);
  Loc mat16 = alloc_node(2);
  Loc ref17 = alloc_node(2);
  set(ref17 + 0, term_new(DP1, 0, dup11 + 0));
  set(ref17 + 1, term_new(VAR, 0, lam14 + 0));
  set(mat16 + 0, term_new(REF, 8, ref17));
  Loc lam18 = alloc_node(1);
  Loc lam19 = alloc_node(1);
  Loc ctr20 = alloc_node(2);
  Loc ctr21 = alloc_node(2);
  set(ctr21 + 0, term_new(VAR, 0, lam15 + 0));
  set(ctr21 + 1, term_new(VAR, 0, lam19 + 0));
  set(ctr20 + 0, term_new(VAR, 0, lam18 + 0));
  set(ctr20 + 1, term_new(CTR, 4, ctr21));
  set(lam19 + 0, term_new(CTR, 0, ctr20));
  set(lam18 + 0, term_new(LAM, 0, lam19));
  set(mat16 + 1, term_new(LAM, 0, lam18));
  set(lam15 + 0, term_new(MAT, 0, mat16));
  set(lam14 + 0, term_new(LAM, 0, lam15));
  set(mat12 + 1, term_new(LAM, 0, lam14));
  set(lam10 + 0, term_new(MAT, 0, mat12));
  set(lam9 + 0, term_new(LAM, 0, lam10));
  set(mat2 + 2, term_new(LAM, 0, lam9));
  Loc app22 = alloc_node(2);
  set(app22 + 0, term_new(SWI, 2, mat2));
  set(app22 + 1, arg1);
  return term_new(APP, 0, app22);
}

Term list_to_tree_slow_f(Term ref) {
  u64 itrs = 0;
  Term arg0 = got(term_loc(ref) + 0);
  Term arg1 = got(term_loc(ref) + 1);
  while (1) {
    ...
    if (term_tag(val2) == W32) {
      ...
      switch (num3) {
        case 0: {
          Term val4 = (arg1);
          if (term_tag(val4) == CTR) {
            switch (term_lab(val4) - 1) {
              case 0: {
                itrs += 3;
                *HVM.itrs += itrs;
              ...
              case 1: {
                Term fd6 = got(term_loc(val4) + 0);
                Term fd7 = got(term_loc(val4) + 1);
                itrs += 5;
                Loc ctr8 = alloc_node(2);
                Loc ctr9 = alloc_node(1);
                set(ctr9 + 0, fd6);
                set(ctr8 + 0, fd7);
                set(ctr8 + 1, term_new(CTR, 3, ctr9));
                *HVM.itrs += itrs;
                return term_new(CTR, 0, ctr8);
                break;
              }
            }
          }
          set(term_loc(ref) + 0, arg0);
          set(term_loc(ref) + 1, arg1);
          return list_to_tree_slow_t(ref);
          break;
        }
        default: {
          Term pre10 = term_new(W32, 0, num3 - 1);
          Term val11 = (pre10);
          Term dpA12;
          Term dpB13;
          if (term_is_atom(val11)) {
            itrs += 1;
            dpA12 = val11;
            dpB13 = val11;
          } else {
            Loc dup14 = alloc_node(1);
            set(dup14 + 0, val11);
            dpA12 = term_new(DP0, 0, dup14 + 0);
            dpB13 = term_new(DP1, 0, dup14 + 0);
          }
          Loc ref15 = alloc_node(2);
          set(ref15 + 0, dpA12);
          set(ref15 + 1, arg1);
          Term val16 = (term_new(REF, 8, ref15));
          if (term_tag(val16) == CTR) {
            switch (term_lab(val16) - 0) {
              case 0: {
                Term fd18 = got(term_loc(val16) + 0);
                Term fd19 = got(term_loc(val16) + 1);
                Loc ref20 = alloc_node(2);
                set(ref20 + 0, dpB13);
                set(ref20 + 1, fd18);
                Term val21 = (term_new(REF, 8, ref20));
                if (term_tag(val21) == CTR) {
                  switch (term_lab(val21) - 0) {
                    case 0: {
                      Term fd23 = got(term_loc(val21) + 0);
                      Term fd24 = got(term_loc(val21) + 1);
                      itrs += 9;
                      Loc ctr25 = alloc_node(2);
                      Loc ctr26 = alloc_node(2);
                      set(ctr26 + 0, fd19);
                      set(ctr26 + 1, fd24);
                      set(ctr25 + 0, fd23);
                      set(ctr25 + 1, term_new(CTR, 4, ctr26));
                      *HVM.itrs += itrs;
                      return term_new(CTR, 0, ctr25);
                      break;
                    }
                  }
                }
...
Term list_to_tree_fast_par_t(Term ref) {
  Term arg0 = got(term_loc(ref) + 0);
  Term arg1 = got(term_loc(ref) + 1);
  Loc mat2 = alloc_node(3);
  set(mat2 + 0, arg0);
  Loc lam3 = alloc_node(1);
  set(lam3 + 0, term_new(W32, 0, 0));
  set(mat2 + 1, term_new(LAM, 0, lam3));
  Loc lam4 = alloc_node(1);
  Loc lam5 = alloc_node(1);
  set(lam5 + 0, term_new(W32, 0, 1));
  set(lam4 + 0, term_new(LAM, 0, lam5));
  set(mat2 + 2, term_new(LAM, 0, lam4));
  Loc app6 = alloc_node(2);
  set(app6 + 0, term_new(SWI, 2, mat2));
  set(app6 + 1, arg1);
  return term_new(APP, 0, app6);
}

Term list_to_tree_fast_par_f(Term ref) {
  u64 itrs = 0;
  Term arg0 = got(term_loc(ref) + 0);
  Term arg1 = got(term_loc(ref) + 1);
  while (1) {
    ...
    set(term_loc(ref) + 0, arg0);
    set(term_loc(ref) + 1, arg1);
    return list_to_tree_fast_par_t(ref);
  }
}


Term N_t(Term ref) {
  return term_new(W32, 0, 3);
}
...
Term main_t(Term ref) {
  Loc ref0 = alloc_node(2);
  Loc ref1 = alloc_node(0);
  Loc ref2 = alloc_node(2);
  Loc opx3 = alloc_node(2);
  Loc ref4 = alloc_node(0);
  set(opx3 + 0, term_new(W32, 0, 1));
  set(opx3 + 1, term_new(REF, 10, ref4));
  set(ref2 + 0, term_new(OPX, 14, opx3));
  set(ref2 + 1, term_new(W32, 0, 0));
  set(ref0 + 0, term_new(REF, 10, ref1));
  set(ref0 + 1, term_new(REF, 1, ref2));
  return term_new(REF, 8, ref0);
}

Term main_f(Term ref) {
  u64 itrs = 0;
  while (1) {
    itrs += 0;
    Loc ref0 = alloc_node(2);
    Loc ref1 = alloc_node(0);
    Loc ref2 = alloc_node(2);
    Loc ref7 = alloc_node(0);
    Term nu05 = (term_new(W32, 0, 1));
    Term nu16 = (term_new(REF, 10, ref7));
    Term ret4;
    if (term_tag(nu05) == W32 && term_tag(nu16) == W32) {
      itrs += 2;
      ret4 = term_new(W32, 0, term_loc(nu05) << term_loc(nu16));
    } else {
      Loc opx3 = alloc_node(2);
      set(opx3 + 0, nu05);
      set(opx3 + 1, nu16);
      ret4 = term_new(OPX, 14, opx3);
    }
    set(ref2 + 0, ret4);
    set(ref2 + 1, term_new(W32, 0, 0));
    set(ref0 + 0, term_new(REF, 10, ref1));
...
int main() {
  hvm_init();
  hvm_define(0, is_node_f);
  hvm_define(1, range_f);
  hvm_define(2, fst_f);
  hvm_define(3, snd_f);
  hvm_define(4, tm0_f);
  hvm_define(5, tm1_f);
  hvm_define(6, mut_f);
  hvm_define(7, spt_f);
  hvm_define(8, list_to_tree_slow_f);
  hvm_define(9, list_to_tree_fast_par_f);
  hvm_define(10, N_f);
  hvm_define(11, main_f);

  clock_t start = clock();
  Term root = term_new(REF, 11, 0);
  normal(root);
