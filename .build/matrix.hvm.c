...
Term Tree_sum_f(Term);
Term tree_f(Term);
Term main_f(Term);
Term LOG_f(Term);
Term SUP_f(Term);
Term DUP_f(Term);
Term Tree_sum_t(Term);
Term tree_t(Term);
Term main_t(Term);
Term LOG_t(Term);
Term SUP_t(Term);
...
Term Tree_sum_t(Term ref) {
  Term arg0 = got(term_loc(ref) + 0);
  Loc mat1 = alloc_node(3);
  set(mat1 + 0, arg0);
  Loc lam2 = alloc_node(1);
  set(lam2 + 0, term_new(VAR, 0, lam2 + 0));
  set(mat1 + 1, term_new(LAM, 0, lam2));
  Loc lam3 = alloc_node(1);
  Loc lam4 = alloc_node(1);
  Loc opx5 = alloc_node(2);
  Loc ref6 = alloc_node(1);
  set(ref6 + 0, term_new(VAR, 0, lam3 + 0));
  Loc ref7 = alloc_node(1);
  set(ref7 + 0, term_new(VAR, 0, lam4 + 0));
  set(opx5 + 0, term_new(REF, 0, ref6));
  set(opx5 + 1, term_new(REF, 0, ref7));
  set(lam4 + 0, term_new(OPX, 0, opx5));
  set(lam3 + 0, term_new(LAM, 0, lam4));
  set(mat1 + 2, term_new(LAM, 0, lam3));
  return term_new(MAT, 0, mat1);
}

Term Tree_sum_f(Term ref) {
  u64 itrs = 0;
  Term arg0 = got(term_loc(ref) + 0);
  while (1) {
    Term val1 = (arg0);
    if (term_tag(val1) == CTR) {
      switch (term_lab(val1) - 0) {
        ...
        case 1: {
          Term fd4 = got(term_loc(val1) + 0);
          Term fd5 = got(term_loc(val1) + 1);
          itrs += 3;
          Loc ref10 = alloc_node(1);
          set(ref10 + 0, fd4);
          Loc ref11 = alloc_node(1);
          set(ref11 + 0, fd5);
          Term nu08 = (term_new(REF, 0, ref10));
          Term nu19 = (term_new(REF, 0, ref11));
          Term ret7;
          if (term_tag(nu08) == W32 && term_tag(nu19) == W32) {
            itrs += 2;
            ret7 = term_new(W32, 0, term_loc(nu08) + term_loc(nu19));
          } else {
            Loc opx6 = alloc_node(2);
            set(opx6 + 0, nu08);
            set(opx6 + 1, nu19);
            ret7 = term_new(OPX, 0, opx6);
          }
          *HVM.itrs += itrs;
          return ret7;
          break;
    ...
    return Tree_sum_t(ref);
  }
}


Term tree_t(Term ref) {
  Term arg0 = got(term_loc(ref) + 0);
  Loc mat1 = alloc_node(3);
  set(mat1 + 0, arg0);
  Loc ctr2 = alloc_node(1);
  set(ctr2 + 0, term_new(W32, 0, 1));
  set(mat1 + 1, term_new(CTR, 0, ctr2));
  Loc lam3 = alloc_node(1);
  Loc dup4 = alloc_node(1);
  Loc ref5 = alloc_node(1);
  set(ref5 + 0, term_new(VAR, 0, lam3 + 0));
  set(dup4 + 0, term_new(REF, 1, ref5));
  Loc ctr6 = alloc_node(2);
  set(ctr6 + 0, term_new(DP0, 0, dup4 + 0));
  set(ctr6 + 1, term_new(DP1, 0, dup4 + 0));
  set(lam3 + 0, term_new(CTR, 1, ctr6));
  set(mat1 + 2, term_new(LAM, 0, lam3));
  return term_new(SWI, 2, mat1);
}

Term tree_f(Term ref) {
  u64 itrs = 0;
  Term arg0 = got(term_loc(ref) + 0);
  while (1) {
    Term val1 = (arg0);
    if (term_tag(val1) == W32) {
      ...
      switch (num2) {
        case 0: {
          itrs += 1;
          Loc ctr3 = alloc_node(1);
          set(ctr3 + 0, term_new(W32, 0, 1));
          *HVM.itrs += itrs;
          return term_new(CTR, 0, ctr3);
          break;
        }
        default: {
          Term pre4 = term_new(W32, 0, num2 - 1);
          Loc ref5 = alloc_node(1);
          set(ref5 + 0, pre4);
          Term val6 = (term_new(REF, 1, ref5));
          Term dpA7;
          Term dpB8;
          if (term_is_atom(val6)) {
            itrs += 1;
            dpA7 = val6;
            dpB8 = val6;
          } else {
            Loc dup9 = alloc_node(1);
            set(dup9 + 0, val6);
            dpA7 = term_new(DP0, 0, dup9 + 0);
            dpB8 = term_new(DP1, 0, dup9 + 0);
          }
          itrs += 2;
...
Term main_t(Term ref) {
  Loc ref0 = alloc_node(1);
  Loc ref1 = alloc_node(1);
  set(ref1 + 0, term_new(W32, 0, 7));
  set(ref0 + 0, term_new(REF, 1, ref1));
  return term_new(REF, 0, ref0);
}
